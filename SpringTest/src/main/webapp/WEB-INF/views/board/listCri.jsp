...
<script type="text/javascript">
	var result = '${result}'; //boardController의 result의 값 success가 나오게 된다.
	if (result == 'success') {
		alert("글이 작성되었습니다.");
	}

	var msg_remove = '${msg_remove}'; //boardController의 msg_remove의 값 success가 나오게 된다.
	if (msg_remove == 'success') {
		alert("글이 삭제되었습니다.");
	}
</script>
